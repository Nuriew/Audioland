...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["https://sowear.shop/"],  # Güvenlik için burada sadece kendi domainini kullanman önerilir
...
async def process_download(url: str, platform: str):
    ...
    if os.path.exists(mp3_file):
        return {"audioUrl": f"https://173.249.60.195:5000/download-file/{unique_id}.mp3"}
    else:
